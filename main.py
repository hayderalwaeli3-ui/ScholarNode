...
# إعداد وتصحيح الاتصال بمكتبة OpenAI - تنظيف المفتاح القديم تلقائياً لمنع خطأ 401
try:
    from openai import OpenAI
    if "OPENAI_API_KEY" in st.secrets:
        # دالة .strip() تضمن إزالة أي مسافات أو أسطر زائدة تم لصقها بالخطأ مع مفتاحك القديم
